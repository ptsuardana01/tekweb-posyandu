<x-user-dashboard>
    <div class="flex flex-col h-full bg-white rounded overflow-hidden shadow-lg">
        {{-- <a href="post.html" class="flex flex-wrap no-underline hover:no-underline"> --}}
            <div class="flex items-center justify-center mt-auto bg-white rounded-b rounded-t-none overflow-hidden p-6">
                <img class="w-24 h-24 rounded-full mr-4 avatar" data-tippy-content="Author Name" src="http://i.pravatar.cc/300" alt="Avatar of Author">
            </div>
