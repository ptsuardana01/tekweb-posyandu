                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody class="text-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="text-left py-3 px-4 text-sm">{{$bumil->telp}}</td>
                            <td class="text-left py-3 px-4 text-sm"><a href="">{{$bumil->email}}</a></td>
                            <td class="text-left py-3 px-4">{{$bumil->umur}}th</td>
                            <td class="text-left py-3 px-4">{{$bumil->tb}}cm</td>
                            <td class="text-left py-3 px-4">{{$bumil->bb}}kg</td>
                            <td class="text-left py-3 px-4">{{$bumil->lila}}cm</td>
                            <td class="text-center py-3 px-4">{{$bumil->kader_id_bumil}}</td>
